  ...
  return (
    ...
    <div className='bottom-container'>
         ...
         <img
               ...
               <div className='eco-friently-parah'>We're not just builders; we're your partners in creating lasting legacies. With a keen eye for quality, safety, and punctuality, we craft dreams into reality.</div>
         
         </div>
       
    </div>
    <div className='bottom-para'>"Consult with us to unlock insights and enrich your understanding of construction. Together, we can elevate your knowledge and bring your vision to life."</div>
