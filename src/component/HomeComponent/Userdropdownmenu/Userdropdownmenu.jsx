...
const UserDropdown = () => {
  ...
  const handleFileChange = (event) => {
    ...
    // You can perform additional checks here, such as file size, type, etc.
    if (file) {
      ...
      {isMenuOpen && (
        <div className="dropdown-menu">
          <button className="close-button" onClick={toggleMenu}>
            <img width="25" height="25" src="https://img.icons8.com/pastel-glyph/64/737373/cancel--v1.png" alt="cancel--v1"/>
          </button>
            ...
            <ul className='list'>
              <div className='bag-containerA'>
                <a href="/order-summary">
                  <li><img width="20" height="20" src="https://img.icons8.com/ios-glyphs/30/737373/shopping-bag.png" alt="shopping-bag"/>My orders</li>
                </a>
              </div>
              <div className='bag-containerB'>
                <li><img width="20" height="20" src="https://img.icons8.com/ios-filled/50/737373/like--v1.png" alt="like--v1"/>Wishlist</li>
              </div>
              <div className='bag-containerC'>
                <li><img width="20" height="20" src="https://img.icons8.com/ios-filled/50/737373/settings.png" alt="settings"/>Settings</li>
              </div>
            </ul>
          </div>
