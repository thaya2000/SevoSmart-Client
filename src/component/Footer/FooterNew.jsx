...
import footerimg from "../../assets/footer_sample.jpg";

const FooterNew = () => {
  return (
    <div className="footer">
      <div className="footerTop">
        <img src={footerimg} className="footer-image" alt="" />
      </div>
      <div className="details">
        <div className="contact">
          <span>Contact Us</span>
          <span>SEVO SMART TECH (PVT) LTD.</span>
          <span>Kiri-vasa, Chenaikudyruppu-01A,Kalmunai.</span>
        ...
        <div className="socialMedia">
          ...
          <div style={{ display: "flex", gap: "10px" }}>
            <a
              href="https://www.facebook.com/sevosmart2021?mibextid=LQQJ4d"
              target="_blank"
